...
const data = [
  { id: 1, fullname: "John Deo", email: "johndeo@gmail.com", role: "rider", date: "july 2020", activate: true},
  { id: 2, fullname: "Lilian Koose", date: "july 2020", email: "liliankoose@gmail.com", role: "agent", activate: false},
  { id: 2, fullname: "Mark Leo", date: "july 2020", email: "markleo@gmail.com", role: "admin", activate: true},
  { id: 2, fullname: "Rose Kalin", date: "july 2020", email: "rosekalin@gmail.com", role: "user", activate: false}
];
    ...
    <Layout>
      <Container>
        ...
        <Flex alignItems='center' justifyContent='space-between' py='4'>
          ...
          <Button colorScheme='green' onClick={onOpen} leftIcon={<AiOutlinePlus />}>
            Add User
          </Button>
          <Modal isOpen={isOpen} onClose={onClose}>
            <Box textAlign="center">
              <ModalHeader size="2xl" color="gray" fontWeight="bold">Add User</ModalHeader>
                ...
                <form onSubmit={handleAddUser}>
                  <Grid gridTemplateColumns="repeat(2, 1fr)" gap="5">
                    ...
                    <FormControl>
                      ...
                      <Select>
                        <option value="" bg="green">Activate</option>
                        <option value="" bg="red">Deactivate</option>
                      </Select>
                    </FormControl>
                  </Grid>
                  <Box textAlign="center" mt="10">
                    <Button colorScheme='red' px="10">Send</Button>
                  </Box>
                </form>
              </Box>
            </Box>
              ...
              <tbody>
                {data.map((user) => (
                  <tr key={user.id}>
                    ...
                    <td>{user.date}</td>
                    <td>
                        <Button colorScheme="green" onClick={() => handleActivate(user.status)} size="sm" mr='2'>Activate</Button>
                        <Button colorScheme="red" onClick={() => handleDeactivate(user.status)} size="sm" mr='-px'>Deactivated</Button>
                    </td>
                    <td>
                      <Button onClick={() => handleDelete(user.id)} variant='outline' color="red" fontSize="1.5rem"><BiTrash /></Button>
                    </td>
                  </tr>
                ))}
              </tbody>
